...
_bg_tasks: set = set()
_TITLE_PROMPT = (
    "Сгенерируй короткий заголовок чата по первому сообщению пользователя — "
    "3–5 слов, отражающих суть запроса, на языке сообщения. "
    "Не добавляй информацию, которой нет в сообщении, и не расшифровывай сокращения. "
    "Если суть непонятна — кратко перефразируй как есть, ничего не выдумывая. "
    "Без кавычек и без точки в конце. В ответе только заголовок."
)
