...
_bg_tasks: set = set()
_TITLE_PROMPT = (
    "Ты придумываешь короткое название для чата по первому сообщению пользователя. "
    "Сформулируй ТЕМУ обращения в 2–4 словах своими словами, не копируй текст дословно. "
    "Это должно быть существительное-тема, а не пересказ. "
    "Без кавычек, без точки в конце, на языке сообщения. Верни только название."
)
